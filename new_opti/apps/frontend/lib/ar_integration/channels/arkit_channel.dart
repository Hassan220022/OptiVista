...
/// Platform channel for ARKit (iOS) communication
class ARKitChannel {
  static const MethodChannel _channel = MethodChannel('com.optivista/arkit');
  ...
  Future<bool> initializeSession() async {
    try {
      ...
      throw ARException('Failed to initialize ARKit session: ${e.message}');
    }
  }
...
/// Custom exception for AR operations
